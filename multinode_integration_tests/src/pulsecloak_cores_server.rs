...
pub struct PulseCloakCoresServer {
...
impl PulseCloakCoresServer {
    pub fn new(chain: Chain) -> PulseCloakCoresServer {
    ...
    fn find_local_integration_net_ip_address() -> IpAddr {
        IpAddr::V4(Ipv4Addr::new(
            ...
            18,
            0,
            if PulseCloakNodeCluster::is_in_jenkins() {
                2
            } else {
                1
            },

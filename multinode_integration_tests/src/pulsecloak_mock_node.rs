...
pub struct PulseCloakMockNode {
    ...
    guts: Rc<PulseCloakMockNodeGuts>,
}
...
impl Clone for PulseCloakMockNode {
    fn clone(&self) -> Self {
        PulseCloakMockNode {
...
impl PulseCloakNode for PulseCloakMockNode {
    fn name(&self) -> &str {
...
pub struct MutablePulseCloakMockNode {
    pub control_stream: RefCell<TcpStream>,
    configurable_guts: PulseCloakMockNodeGuts,
}

impl MutablePulseCloakMockNode {
    pub fn absorb_configuration(&mut self, node_record: &NodeRecord) {
        // Copy attributes from the NodeRecord into the PulseCloakNode.
        self.configurable_guts.earning_wallet = node_record.earning_wallet();
        self.configurable_guts.rate_pack = *node_record.rate_pack();
    }
}

impl From<MutablePulseCloakMockNode> for PulseCloakMockNode {
    fn from(mutable_handle: MutablePulseCloakMockNode) -> Self {
        PulseCloakMockNode {
...
pub trait PulseCloakMockNodeStarter<T> {
    fn start(
        &self,
        ports: Vec<u16>,
        index: usize,
...
pub struct ImmutablePulseCloakMockNodeStarter {}

impl PulseCloakMockNodeStarter<PulseCloakMockNode> for ImmutablePulseCloakMockNodeStarter {
    fn start(
        &self,
        ports: Vec<u16>,
        index: usize,
        ...
        let (control_stream, mock_node_guts) = PulseCloakMockNode::start_pulsecloak_mock_node_with_bare_guts(
            ports,
            index,
...
pub struct MutablePulseCloakMockNodeStarter {}

impl PulseCloakMockNodeStarter<MutablePulseCloakMockNode> for MutablePulseCloakMockNodeStarter {
    fn start(
        &self,
        ports: Vec<u16>,
        index: usize,
...
impl PulseCloakMockNode {
    ...
    pub fn transmit_debut(&self, receiver: &dyn PulseCloakNode) -> Result<(), Error> {
    ...
    pub fn transmit_pass(
        &self,
        receiver: &dyn PulseCloakNode,
        target: &dyn PulseCloakNode,
    ) -> Result<(), Error> {
    ...
    fn start_pulsecloak_mock_node_with_bare_guts(
        ports: Vec<u16>,
        index: usize,
        host_node_parent_dir: Option<String>,
        public_key_opt: Option<&PublicKey>,
        chain: Chain,
    ) -> (RefCell<TcpStream>, PulseCloakMockNodeGuts) {
    ...
    fn start_with_cryptde_enum(
        ...
        PulseCloakMockNode::do_docker_run(&node_addr, host_node_parent_dir, &name);
        let wait_addr = SocketAddr::new(node_addr.ip_addr(), CONTROL_STREAM_PORT);
        let control_stream = RefCell::new(PulseCloakMockNode::wait_for_startup(wait_addr, &name));
        let framer = RefCell::new(DataHunkFramer::new());
        let guts = PulseCloakMockNodeGuts {
            name,
            node_addr,
            earning_wallet,
            consuming_wallet,
...
impl Drop for PulseCloakMockNodeGuts {
    fn drop(&mut self) {

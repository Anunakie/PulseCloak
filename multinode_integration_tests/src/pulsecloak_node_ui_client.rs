...
pub struct PulseCloakNodeUIClient {
    inner: RefCell<PulseCloakNodeUIClientInner>,
}

struct PulseCloakNodeUIClientInner {
    client: Client<TcpStream>,
    buffer: Vec<MessageBody>,
}

impl PulseCloakNodeUIClient {
    pub fn new(addr: SocketAddr) -> Self {
        ...
        Self {
            inner: RefCell::new(PulseCloakNodeUIClientInner {
                client,
                buffer: vec![],
            }),
        }
    ...
    fn check_for_waiting_message(
        &self,
        inner: &mut RefMut<PulseCloakNodeUIClientInner>,
    ) -> Option<MessageBody> {

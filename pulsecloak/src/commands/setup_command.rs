...
use pulsecloak_lib::as_any_ref_in_trait_impl;
use pulsecloak_lib::constants::SETUP_ERROR;
...
use pulsecloak_lib::shared_schema::{data_directory_arg, shared_app};
use pulsecloak_lib::short_writeln;
use pulsecloak_lib::utils::{index_of_from, DATA_DIRECTORY_DAEMON_HELP};
use std::fmt::Debug;
use std::io::Write;
...
const SETUP_COMMAND_ABOUT: &str =
    "Establishes (if Node is not already running) and displays startup parameters for PulseCloakNode.";
...
mod tests {
    ...
    use pulsecloak_lib::messages::UiSetupResponseValueStatus::{Configured, Default, Set};
    use pulsecloak_lib::messages::{UiSetupRequest, UiSetupResponse, UiSetupResponseValue};
            ...
            .transact_result(Ok(UiSetupResponse {
                ...
                values: vec![
                    ...
                    UiSetupResponseValue::new(
                        "neighbors",
                        "pulsecloak://eth-mainnet:95VjByq5tEUUpDcczA__zXWGE6-7YFEvzN4CDVoPbWw@13.23.13.23:4545",
                        Set,
                    ),
...
neighbors                     pulsecloak://eth-mainnet:95VjByq5tEUUpDcczA__zXWGE6-7YFEvzN4CDVoPbWw@13.23.13.23:4545 Set\n\
    ...
    fn setup_command_with_data_directory_shows_right_path() {
        ...
        vec![
            SetupCommandData {
                ...
                data_directory_expected: Some("/home/cooga/.local/PulseCloak/polygon-mainnet"),
                note_expected: false,
            ...
            SetupCommandData {
                ...
                data_directory_expected: Some("/home/cooga/.local/PulseCloak/polygon-amoy"),
                note_expected: true,
...
{:29} {:64} {}\n{:29} {:64} {}\n{}\n",
            ...
            let data_directory_real = match &data.data_directory {
                ...
                _ => format!("/home/cooga/.local/PulseCloak/{}", chain_real)
            };

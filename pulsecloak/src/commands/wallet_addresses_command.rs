...
use pulsecloak_lib::messages::{UiWalletAddressesRequest, UiWalletAddressesResponse};
...
mod tests {
    ...
    use pulsecloak_lib::messages::{ToMessageBody, UiWalletAddressesRequest, UiWalletAddressesResponse};

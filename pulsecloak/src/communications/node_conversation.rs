...
use pulsecloak_lib::ui_traffic_converter::UnmarshalError;
...
mod tests {
    ...
    use pulsecloak_lib::messages::FromMessageBody;
    use pulsecloak_lib::messages::ToMessageBody;
    use pulsecloak_lib::messages::{UiShutdownRequest, UiShutdownResponse, UiUnmarshalError};

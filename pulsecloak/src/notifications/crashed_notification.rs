...
use pulsecloak_lib::messages::{CrashReason, UiNodeCrashedBroadcast};
use pulsecloak_lib::short_writeln;
#[cfg(target_os = "windows")]
use pulsecloak_lib::utils::exit_process;
#[cfg(not(target_os = "windows"))]
use pulsecloak_lib::utils::exit_process_with_sigterm;
use std::io::Write;
...
mod tests {
    ...
    #[test]
    #[should_panic(expected = "The Daemon is no longer running; pulsecloak is terminating.")]

...
use pulsecloak_lib::constants::{DEFAULT_UI_PORT, HIGHEST_USABLE_PORT, LOWEST_USABLE_INSECURE_PORT};
...
const APP_NAME: &str = "pulsecloak";
const APP_VERSION: &str = "1.0.0";
const APP_AUTHOR: &str = "PulseCloak";
const APP_ABOUT: &str =
...
mod tests {
    ...
    fn constants_have_correct_values() {
        assert_eq!(APP_NAME, "pulsecloak");
        assert_eq!(APP_VERSION, "1.0.0");
        assert_eq!(APP_AUTHOR, "PulseCloak");
        assert_eq!(
            APP_ABOUT,
            "pulsecloak is a command-line user interface to the PulseCloak Daemon and the PulseCloak Node"
        );

...
use crate::terminal::secondary_infrastructure::{PulseCloakTerminal, WriterLock};
...
pub const PCLOAK_TEST_INTEGRATION_KEY: &str = "PCLOAK_TEST_INTEGRATION";
pub const PCLOAK_TEST_INTEGRATION_VALUE: &str =
...
impl IntegrationTestTerminalConsole {
    fn input_reader(&mut self, result_sender: Sender<TerminalEvent>) {
        self.write_with_sync(PCLOAK_PROMPT);
...
impl PulseCloakTerminal for IntegrationTestTerminal {
...
mod tests {
    ...
    fn constants_have_correct_values() {
        assert_eq!(PCLOAK_TEST_INTEGRATION_KEY, "PCLOAK_TEST_INTEGRATION");
    }
    ...
    fn integration_test_terminal_provides_synchronization() {
        ...
        assert_eq!(filtered_string, "pulsecloak> ");
    }

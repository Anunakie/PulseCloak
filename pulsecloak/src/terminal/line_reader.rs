...
use crate::terminal::secondary_infrastructure::{InterfaceWrapper, PulseCloakTerminal, WriterLock};
...
impl PulseCloakTerminal for TerminalReal {
    ...
    fn lock_without_prompt(
        ...
        short_writeln!(
            ...
            "{}",
            format!("{}{}", PCLOAK_PROMPT, kept_buffer)
        );
        lock
    }
...
mod tests {
    ...
    fn lock_without_prompt_utilizes_inner_components_properly() {
        ...
        assert_eq!(
            ...
            "pulsecloak> my once opened writing\n".to_string()
        );

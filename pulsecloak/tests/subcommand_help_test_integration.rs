...
use pulsecloak_lib::test_utils::utils::check_if_source_code_is_attached;
use pulsecloak_lib::test_utils::utils::ShouldWeRunTheTest::Skip;
use regex::Regex;
...
fn assure_that_all_subcommands_hang_on_the_help_root_integration() {
    ...
    let help_handle = PulseCloakProcess::new().start_noninteractive(vec!["--help"]);
